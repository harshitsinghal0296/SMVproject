package com.example.asus.story.multispinner;
...
import com.example.asus.story.R;
...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<String>(getContext(), R.layout.textview_for_spinner, new String[]{spinnerText}) {
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                Typeface monstRegular = Typeface.createFromAsset(getContext().getAssets(), "fonts/Montserrat-Regular.ttf");
    ...
    public boolean performClick() {
       ...
       // builder.setTitle(spinnerTitle);
        ...
        empty.setTypeface(monstRegular);
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.textView.setTypeface(monstRegular, Typeface.NORMAL);
